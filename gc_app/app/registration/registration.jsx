					...
					<div className="registrationinnercontainer">
						<form onSubmit={handleSubmit}>
							<div className="centereditems">
								<Input.Wrapper label="Brukernavn" withAsterisk>
									<Input
										value={userName}
								...
								<Input.Wrapper label="Fornavn" withAsterisk>
									<Input
										type="string"
										value={firstName}
										placeholder="Navn"
								...
								<Input.Wrapper label="Etternavn" withAsterisk>
									<Input
										type="string"
										value={lastName}
										placeholder="Navnson"
								...
								<Input.Wrapper label="E-post" withAsterisk>
									<Input
										type="email"
										value={email}
